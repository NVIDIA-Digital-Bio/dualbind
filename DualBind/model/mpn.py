...
"""A message passing neural network, which serves as the molecular graph embedding layer in DualBind. This MPNEncoder is adapted from https://chemprop.readthedocs.io/en/v1.7.1/_modules/chemprop/models/mpn.html#MPNEncoder."""
